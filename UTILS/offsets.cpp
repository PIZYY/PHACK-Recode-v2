...
namespace OFFSETS
{
	...
	void InitOffsets()
	{
		...
		INTERFACES::cvar->ConsoleColorPrintf(CColor(255, 0, 0, 255), "[PHACK v2] \n");
		INTERFACES::cvar->ConsoleColorPrintf(CColor(0, 255, 0, 255), "[Offset parse start] \n");
		m_fLastShotTime = UTILS::netvar_hook_manager.GetOffset("DT_WeaponCSBase", "m_fLastShotTime");
		...
		m_flMaxspeed = UTILS::netvar_hook_manager.GetOffset("DT_BasePlayer", "m_flMaxspeed");
