...
namespace GLOBAL
{
	...
	extern std::string resolver_mode;
}
namespace FONTS
{
...
namespace SETTINGS
{
	...
	public:
		...
		bool hit_list;
		bool wire_hand;
		float wire_color_h[4] = { 1.0f,1.0f,0.5f,0.5f };
		int fakestand;
		int fakeduckver;
		int reslvermod;
		bool breaklby;
		float fakechams_col[4] = { 1.0f,1.0f,1.0f,1.0f };
		float fakechams_col_back[4] = { 1.0f,1.0f,1.0f,1.0f };
		bool antibackshoot;
		bool multiboxx;
		/*легитбот*/
		int pistolhit;
