...
#define TEXTURE_GROUP_MORPH_TARGETS					"Morph Targets"
	...
	public:
		...
		IMaterial* CreateMaterialBasic2(bool shouldIgnoreZ, bool isLit, bool isWireframe)
		{
		...
		\n}\n"
			...
			LoadFromBuffer(keyValues, szName, szMaterial);

			IMaterial *createdMaterial = CreateMaterial(szName, keyValues);
